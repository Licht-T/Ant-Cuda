...
__host__ void getDevicePtrs(){
    ...
    cudaGetSymbolAddress((void**)&min_path1_d_ptr_raw, min_path1_d);
    min_path1_d_ptr = thrust::device_ptr<Cell>(min_path1_d_ptr_raw);

    cudaGetSymbolAddress((void**)&min_path2_d_ptr_raw, min_path2_d);
...
__host__ void initialize(){
    ...
    cudaMemcpyFromSymbol(&x_Nest2Food, x_Nest2Food_d, sizeof(double)*2);
    cudaMemcpyFromSymbol(&y_Nest2Food, y_Nest2Food_d, sizeof(double)*2);
    ...
    cudaMemcpyToSymbol(x_Nest2Food_d, &x_Nest2Food, sizeof(double)*2);
    cudaMemcpyToSymbol(y_Nest2Food_d, &y_Nest2Food, sizeof(double)*2);

...
extern Cell gauss_path1[MACRO_MAX][MACRO_MAX];
extern __device__ Cell gauss_path1_d[MACRO_MAX][MACRO_MAX];
extern Cell *gauss_path1_d_ptr_raw;
extern thrust::device_ptr<Cell> gauss_path1_d_ptr;

extern Cell gauss_path2[MACRO_MAX][MACRO_MAX];
extern __device__ Cell gauss_path2_d[MACRO_MAX][MACRO_MAX];
extern Cell *gauss_path2_d_ptr_raw;
extern thrust::device_ptr<Cell> gauss_path2_d_ptr;
